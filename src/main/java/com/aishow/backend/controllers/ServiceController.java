...
public class ServiceController {
	...
	//Id será desnecessario com o AUTH
	//PASSED
	@PostMapping(value="/api/create",consumes = "application/json", produces = "text/plain")
	...
	//PASSED
	@PostMapping(value="/api/schedule",consumes = "application/json", produces = "text/plain")
	public String scheduleService(@RequestBody ClientServiceInteraction info){
		return new ScheduleServiceHandler().handle(info);
	}

	//PASSED
	@PostMapping(value="/api/update",consumes = "application/json", produces = "text/plain")
